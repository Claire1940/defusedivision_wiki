    ...
    "@graph": [
      {
        ...
        description:
          "Community Defuse Division Wiki covering maps (Dust II, Mirage, Nuke), weapons, skins, economy, movement, and competitive tactics for the Roblox tactical bomb-defusal shooter by Fourteam.",
        image: {
          "@type": "ImageObject",
