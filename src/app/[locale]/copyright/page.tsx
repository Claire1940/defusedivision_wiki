...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    description: 'Copyright and intellectual property information for Defuse Division Wiki. Learn about content ownership, fair use, DMCA policy, and how to report copyright infringement.',
    robots: {
      index: false,
      follow: true,
      googleBot: {
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              © 2025-2026 Defuse Division Wiki. All rights reserved.
            </p>
            <p>
              Unless otherwise noted, all original content on this website, including but not limited to text,
              graphics, logos, guides, articles, and compilations, is the property of Defuse Division Wiki and is
              protected by international copyright laws.
            </p>

            <h3>1.2 Game Assets and Trademarks</h3>
            <p>
              Defuse Division Wiki is an <strong>unofficial fan-made website</strong> and is NOT affiliated with,
            ...
            <p>
              ...
              affiliation with Defuse Division Wiki.
            </p>
            ...
            <p>
              ...
              Defuse Division Wiki<br />
              Email: <a href="mailto:dmca@defusedivision.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@defusedivision.wiki</a>
            </p>
            <p>
            ...
            <ul>
              <li>Provide clear attribution to "Defuse Division Wiki"</li>
              <li>Include a link back to the original page (if digital)</li>
              <li>Do not imply endorsement or affiliation</li>
            </ul>
            <p>
              Example attribution: <em>"Source: Defuse Division Wiki (defusedivision.wiki)"</em>
            </p>
            ...
            <p>
              <strong>General Inquiries:</strong> <a href="mailto:copyright@defusedivision.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">copyright@defusedivision.wiki</a><br />
              <strong>DMCA Notices:</strong> <a href="mailto:dmca@defusedivision.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@defusedivision.wiki</a>
            </p>
            <p>
