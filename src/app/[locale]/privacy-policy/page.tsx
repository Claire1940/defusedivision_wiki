...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Privacy Policy - Defuse Division Wiki',
    description: 'Defuse Division Wiki Privacy Policy. Learn how we collect, use, and protect your data when you use our Roblox game resource platform. Your privacy matters to us.',
    robots: {
      index: false,
      follow: true,
      googleBot: {
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              Defuse Division Wiki ("we", "our", or "us") collects minimal information to provide and improve our services.
            ...
            <p>
              Our website may contain links to external websites, including Roblox, Discord, Reddit, and social media platforms.
            ...
            <h2>11. Disclaimer</h2>
            <p>
              Defuse Division Wiki is an unofficial fan-made website and is not affiliated with, endorsed by, or associated
              with Roblox Corporation or Fourteam, the developers of Defuse Division. All game content, trademarks, and assets are
              the property of their respective owners. Defuse Division is a fan creation and is not affiliated with VALVe.
            </p>
            ...
            <p>
              <strong>Email:</strong> <a href="mailto:privacy@defusedivision.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">privacy@defusedivision.wiki</a>
            </p>
            <p>
