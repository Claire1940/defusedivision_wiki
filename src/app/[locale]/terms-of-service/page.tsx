...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: "Terms of Service - Defuse Division Wiki",
    description: "Read the Terms of Service for Defuse Division Wiki. Learn about user responsibilities, content usage guidelines, and legal terms for using our Roblox game resource platform.",
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      title: "Terms of Service - Defuse Division Wiki",
      description: "Terms and conditions for using Defuse Division Wiki.",
      images: [
        {
      ...
      <section className="relative py-20 px-4 border-b border-border">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-slate-300 text-lg mb-2">
            Terms and conditions for using Defuse Division Wiki
          </p>
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              By accessing and using Defuse Division Wiki ("the Website", "we", "our", or "us"), you agree to be bound
              by these Terms of Service ("Terms"). If you do not agree to these Terms, please do not use our Website.
            </p>
            <p>
              These Terms constitute a legally binding agreement between you ("User", "you", or "your") and Defuse Division Wiki.
              Your continued use of the Website signifies your acceptance of these Terms and any future modifications.
            </p>

            <h2>2. Description of Service</h2>
            <p>
              Defuse Division Wiki is an unofficial, community-driven fan website that provides information, guides, tools,
              and resources related to the Roblox game "Defuse Division" by Fourteam. Our services include, but are not limited to:
            </p>
            <ul>
              <li>Active and expired redeem codes</li>
              <li>Weapons guides and best-buy recommendations</li>
              <li>Skins, cases, and drop pool information</li>
              <li>Maps, callouts, and bomb-site tactics</li>
              <li>Crosshair and settings optimization</li>
              <li>Community discussion and content</li>
            </ul>
            <p>
              <strong>Important:</strong> Defuse Division Wiki is NOT affiliated with, endorsed by, or associated with
              Roblox Corporation or Fourteam, the official developers of Defuse Division. We are an independent fan community.
            </p>
            ...
            <p>
              ...
              graphics, logos, images, and software) are owned by Defuse Division Wiki and are protected by international
            ...
            <p>
              ...
              trademarks, are the property of Roblox Corporation and/or Fourteam, the developers of Defuse Division. We use such
            ...
            <ul>
              ...
              <li><strong>Game Changes:</strong> Defuse Division is in early alpha. Game content, codes, and updates may change without notice. We are not responsible for in-game changes or access issues.</li>
            </ul>
            <p>
            ...
            <p>
              TO THE FULLEST EXTENT PERMITTED BY LAW, DEFUSE DIVISION WIKI SHALL NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL,
            ...
            <p>
              The Website may contain links to third-party websites, including Roblox, Discord, Reddit, social media platforms,
            ...
            <p>
              ...
              you and Defuse Division Wiki regarding the use of the Website and supersede any prior agreements or understandings.
            </p>
            ...
            <p>
              <strong>Email:</strong> <a href="mailto:legal@defusedivision.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">legal@defusedivision.wiki</a>
            </p>
            <p>
